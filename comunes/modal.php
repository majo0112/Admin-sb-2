...
<!-- Modal delete fichas -->
<div class="modal" id="deleteModalFicha" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body text-center">
                <p>¿Estás seguro de que deseas eliminar la ficha?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary btn-cancelar" data-bs-dismiss="modal">Cancelar</button>
                <button type="button" class="btn btn-danger" id="deleteConfirmFicha">Eliminar</button>
            </div>
        </div>
    </div>
</div>

<!-- Modal delete aprendiz -->
<div class="modal" id="deleteModalAprendiz" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body text-center">
                <p>¿Estás seguro de que deseas eliminar este aprendiz?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary btn-cancelar" data-bs-dismiss="modal">Cancelar</button>
                <button type="button" class="btn btn-danger" id="deleteConfirmAprendiz">Eliminar</button>
            </div>
        </div>
    </div>
</div>
