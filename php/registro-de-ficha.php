...
$sql = "SELECT 
f.id, p.nombre_programa, f.ficha, f.alias, s.descripcion AS estado
FROM fichas f
INNER JOIN 
programa p ON f.id_programa = p.id
INNER JOIN 
sub_item s ON f.estado = s.id;";
