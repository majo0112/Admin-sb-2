...
$sql = "SELECT i.id, r.nombre, r.apellidos, f.alias AS id_ficha
FROM instructor i
INNER JOIN register r ON i.id_persona = r.id
INNER JOIN fichas f ON i.id_ficha = f.id";
